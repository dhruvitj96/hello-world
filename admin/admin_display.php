...
while($row=mysqli_fetch_assoc($result))
{
	...
	echo "<tr><td><img src='../moderator/images/".$row['song_image']."' height='50' width='50' /></td>";
	echo "<td><h4> ".$row['song_title']. " </h4></td>";
	echo "<td><audio controls><source src='../moderator/songs/".$row['song']."' type='audio/mpeg'>
</audio></td>";
	echo "<td><h4><a href='update_songs_sts.php'>".$row['status']."</a></h4></td>";
	echo "<td><h4><a href='update_songs_sts.php?sts=Active&id=".$row['song_id']."'>Active</a>  <a href='update_songs_sts.php?sts=Reject&id=".$row['song_id']."'>Reject</a></h4></td>";
